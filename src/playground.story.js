  ...
  return (
    <div style={{ width: "500px" }}>
      <ReactFrappeChart
        ...
        type={select("Type", ["line", "bar", "axis-mixed", "pie", "percentage"], "line")}
        data={{
          labels: array("Labels", ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]),
          datasets: [
            {
              name: "Dataset 1",
              chartType: select("Dataset 1 Type", ["line", "bar", "axis-mixed", "pie", "percentage"], "line"),
              values: array("Dataset 1 Values", [18, 40, 30, 35, 8, 52, 17, 4]),
            },
            {
              name: "Dataset 2",
              chartType: select("Dataset 2 Type", ["line", "bar", "axis-mixed", "pie", "percentage"], "line"),
